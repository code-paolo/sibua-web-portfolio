export const projects = [
  ...
  {
    project_name: "Cinespace – Movie Discovery Application",
    project_description:
      "Built a responsive movie app with search, filters, detailed pages, and optimized performance using SSG/SSR, SEO, and React Query; integrated TMDb API with TailwindCSS and Radix UI for pagination, carousels, and sorting.",
  },
  {
    project_name: "AGFC Management System",
    project_description:
      "Built a full-stack gym management app with complete CRUD capabilities for managing information and schedules",
  },
];
